...
function logTitle() {
  ...
  var tildas = colors.cyan('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
	...
	console.log("");
	console.log(colors.green('_________________________________________________________________________'));
	console.log("");
...
function customerBuy(){
	inquirer.prompt([
			{
			  type: 'input',
			  message: 'What is the id # of the item would like to purchase?',
			  name: 'itemID',
      ...
      var itemID = answer.itemID;            
          ...
          // This is used to nested customer ordering
          inquirer.prompt([
            {
              type: "confirm",
