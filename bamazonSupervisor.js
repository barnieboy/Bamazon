...
function logTitle() {
  ...
  var tildas = colors.cyan('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
	...
	console.log("");
	console.log(colors.magenta('_____________________________________________________________________'));
	console.log("");
...
function showDeptTable() {
    connection.query('SELECT * FROM departments', function(err, results) {        
        ...
        console.log(colors.magenta('_________________________________________________________'));
        console.log("\n" + table.toString());              
        console.log(colors.magenta('_________________________________________________________'));
        console.log("");
    });
