...
function logTitle() {
  ...
  var tildas = colors.cyan('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
	...
	console.log("");
	console.log(colors.red('__________________________________________________'));
	console.log("");
...
//function gives the user a menu of actions
...
function showLowStock() {
    connection.query('SELECT * from products', function(err, results) { 
        ...
        console.log(colors.red('______________________________________________________'));
        console.log("\n" + table.toString());  
        console.log(colors.red('_______________________________________________________'));
        console.log("");
    });
		setTimeout(managerMenu, 1000);
};
